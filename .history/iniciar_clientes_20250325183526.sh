...
env IP_TUPLAS=localhost PORT_TUPLAS=8080 $CLIENT_PATH1 &
CLIENT_PIDS+=($!)

echo "Iniciando cliente 2"
env IP_TUPLAS=localhost PORT_TUPLAS=8080 $CLIENT_PATH2 &
CLIENT_PIDS+=($!)

echo "Iniciando cliente 3"
env IP_TUPLAS=localhost PORT_TUPLAS=8080 $CLIENT_PATH3 &
CLIENT_PIDS+=($!)