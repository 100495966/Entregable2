...
int get_value(int key, char *value1, int *N_value2, double *V_value2, struct Coord *value3) {
    ...
    if ((ret = strtol_handling(buffer, &ret)) != 0) goto cleanup_get_value;
    ...
    if (ret == 0) {
        ...
        // Read N_value2
        if ((ret = readLine(s, buffer, 256)) != 0) goto cleanup_get_value;
        if ((ret = strtol_handling(buffer, N_value2)) != 0) goto cleanup_get_value;
        ...
        // Read value3.x
        if ((ret = readLine(s, buffer, 256)) != 0) goto cleanup_get_value;
        if ((ret = strtol_handling(buffer, &(value3->x))) != 0) goto cleanup_get_value;
        
        // Read value3.y
        if ((ret = readLine(s, buffer, 256)) != 0) goto cleanup_get_value;
        if ((ret = strtol_handling(buffer, &(value3->y))) != 0) goto cleanup_get_value;
    }
